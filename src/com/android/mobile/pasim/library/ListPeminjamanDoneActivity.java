...
public class ListPeminjamanDoneActivity extends Activity {

	private static final String TAG = ListPeminjamanDoneActivity.class
			.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		JsonArrayRequest req = new JsonArrayRequest(
				URLFunctions.URLPEMINJAMANDONE + nimnik,
